...
function ajaxLike(e) {
  ...
  .then(function (res) {
    ...
    _this.parentElement.previousSibling.textContent = res.data.post.likesCount; // Post's likes count
    if (isLiked) {
      _this.like.classList.add('like__button--animate');
      setTimeout(function () {
        return _this.like.classList.remove('like__button--animate');
      }, 1300);
    }
  }).catch(console.error);
}
